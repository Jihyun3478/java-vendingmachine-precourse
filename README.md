...
## 기능 구현 목록
- [ ] [자판기] 사용자로부터 자판기가 보유하고 있는 금액을 입력받는 기능


- [ ] [자판기] 자판기가 보유하고 있는 금액만큼 동전을 무작위로 생성하는 기능
  - [ ] 투입 금액으로는 동전을 생성하지 않는다.


- [ ] [자판기] 자판기가 보유하고 있는 동전의 개수를 출력하는 기능


- [ ] [자판기] 사용자로부터 상품명, 가격, 수량을 입력받고, 상품을 추가하는 기능
  - [ ] 상품 가격은 100원부터 시작하며, 10원으로 나누어떨어져야 한다.


- [ ] [구매] 사용자로부터 투입 금액을 입력받는 기능


- [ ] [구매] 사용자로부터 구매할 상품명을 입력받는 기능


- [ ] [구매] 입력받은 투입 금액과 상품명을 이용해 구매를 진행하는 기능
  - [ ] 남은 금액이 상품의 최저 가격보다 적거나, 모든 상품이 소진된 경우 바로 잔돈을 돌려준다.


- [ ] [잔돈 반환] 잔돈을 돌려줄 때 현재 보유한 최소 개수의 동전으로 잔돈을 돌려주는 기능
  - [ ] 지폐를 잔돈으로 반환하는 경우는 없다고 가정한다.
  - [ ] 잔돈을 반환할 수 없는 경우 잔돈으로 반환할 수 있는 금액만 반환한다.
  - [ ] 반환되지 않은 금액은 자판기에 남는다.
